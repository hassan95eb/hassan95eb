...
I am a **Senior Frontend Engineer and Technical Leader** specializing in the architecture and development of scalable, data-intensive, and real-time applications.

My work sits at the intersection of **frontend architecture, performance engineering, product experience, and engineering leadership**. I focus on transforming complex technical requirements into maintainable systems and fast, intuitive user experiences.

```ts
const hassan = {
  role: "Senior Frontend Engineer & Technical Leader",
  focus: [
  ...
  ecosystem: ["JavaScript", "TypeScript", "React", "Vue", "Next.js"],
  mindset: "Build scalable systems without sacrificing user experience",
};
```
...
* Used **Web Workers** to deliver responsive experiences targeting **60 FPS**
* Improved overall application performance by up to **40%**
* Built scalable web, desktop, and cross-platform mobile applications
* Led technical teams as a former **CTO and Tech Lead**
...
I am interested in conversations and opportunities involving:
...
* Engineering mentorship and collaboration
